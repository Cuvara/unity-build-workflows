...
> - Stable release: use an exact released tag (e.g. `@vX.Y.Z`) — the latest is `@v2.2.4`; see [CHANGELOG.md](CHANGELOG.md) and the repository Releases page.
...
**Pin the version**: `@v2` (latest stable, auto-fixes) or `@v2.2.4` (exact) for
